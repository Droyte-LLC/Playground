...
namespace Campaigns.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Campaigns",
                columns: new[] { "CampaignId", "OwnerId", "Title" },
                values: new object[] { 1, 1, "Save the Forest" });

            migrationBuilder.InsertData(
                table: "Contributions",
                columns: new[] { "ContributionId", "Amount", "CampaignId", "UserId" },
                values: new object[] { 1, 100m, 1, 2 });
